        ...
        <div className="min-h-screen pt-16" style={{ background: 'var(--bg-base)', color: 'var(--fg-primary)' }}>
            <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8 lg:px-12">
                ...
                <header className="mb-12 border-b pb-10" style={{ borderColor: 'var(--border-subtle)' }}>
                    <p className="mb-4 font-mono text-xs uppercase tracking-widest" style={{ color: 'var(--fg-tertiary)', fontFamily: 'var(--font-mono)' }}>— Governed by Romanian & EU Law</p>
                    <h1 className="mb-3 text-4xl font-black tracking-tight" style={{ fontFamily: 'var(--font-display)' }}>Terms of Service</h1>
                ...
                <div className="space-y-12" style={{ color: 'var(--fg-secondary)' }}>
                        ...
                        <dl className="mt-4 space-y-3">
                            {[
                                ...
                                <div key={term} className="flex flex-col gap-1 sm:flex-row sm:gap-3">
                                    <dt className="shrink-0 text-sm font-semibold" style={{ color: 'var(--fg-primary)' }}>{term}</dt>
                            ...
                            <ul className="space-y-2 list-none">
                                {[
                                    ...
                                    <li key={name} className="flex gap-3">
                                        ...
                                        <span><strong style={{ color: 'var(--fg-primary)' }}>{name}:</strong> {desc}</span>
                                    </li>
                                ))}
                            </ul>
                        </SubSection>
                    ...
                    <Section id="5" title="5. Subscription Plans & Billing">
                        <SubSection title="5.1 Pricing & Plans">
                            <p>Obtura offers tiered Subscription plans with flat monthly pricing. Current pricing is available at <a href="https://obtura.dev/pricing" className="hover:underline" style={{ color: 'var(--brand)' }}>obtura.dev/pricing</a>. We are committed to predictable, transparent pricing — there are no usage-based surprise charges.</p>
                        </SubSection>
                    ...
                    <Section id="8" title="8. Intellectual Property">
                        ...
                        <SubSection title="8.3 Third-Party Open Source">
                            <p>The Platform incorporates open-source software. A list of open-source components and their applicable licenses is available at <a href="https://obtura.dev/open-source" className="hover:underline" style={{ color: 'var(--brand)' }}>obtura.dev/open-source</a>. Nothing in these Terms limits rights granted under applicable open-source licenses.</p>
                        </SubSection>
                    </Section>
                            ...
                            <table className="mt-3 w-full border-collapse text-sm">
                                <thead>
                                    <tr className="border-b" style={{ borderColor: 'var(--border-default)' }}>
                                        <th className="py-3 pr-4 text-left font-semibold" style={{ color: 'var(--fg-primary)' }}>Plan</th>
                                        <th className="py-3 text-left font-semibold" style={{ color: 'var(--fg-primary)' }}>Monthly Uptime Target</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {[
                                        ...
                                        <tr key={plan} className="border-b" style={{ borderColor: 'var(--border-subtle)' }}>
                                            <td className="py-3 pr-4">{plan}</td>
                                            <td className="py-3" style={{ color: 'var(--fg-primary)' }}>{sla}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                    ...
                    <Section id="10" title="10. Data Protection & GDPR">
                        ...
                        <SubSection title="10.1 Roles">
                            <p>In relation to your Customer Data, you are the data controller and Obtura acts as a data processor on your behalf. In relation to your account and contact data, Obtura is the data controller. Full details are in our Privacy Policy at <a href="https://obtura.dev/privacy" className="hover:underline" style={{ color: 'var(--brand)' }}>obtura.dev/privacy</a>.</p>
                        </SubSection>

                        <SubSection title="10.2 Data Processing Agreement">
                            <p>Our Data Processing Agreement (DPA), which forms part of these Terms for customers subject to GDPR, governs Obtura&apos;s processing of personal data on your behalf. By accepting these Terms, you also accept the DPA. An executed copy of the DPA is available upon request at <a href="mailto:dpo@obtura.dev" className="hover:underline" style={{ color: 'var(--brand)' }}>dpo@obtura.dev</a>.</p>
                        </SubSection>
                    ...
                    <Section id="13" title="13. Limitation of Liability">
                        <div className="border p-5 mb-5" style={{ borderColor: 'var(--brand-border)', background: 'var(--brand-dim)' }}>
                            <p className="text-sm font-medium leading-relaxed" style={{ color: 'var(--fg-primary)' }}>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW:</p>
                        </div>
                        <p><strong style={{ color: 'var(--fg-primary)' }}>Cap on Liability:</strong> Obtura&apos;s total aggregate liability to you for any claims arising under or related to these Terms or the Platform — whether in contract, tort (including negligence), or otherwise — shall not exceed the total fees paid by you to Obtura in the 12 months immediately preceding the event giving rise to the claim.</p>
                        <p className="mt-4"><strong style={{ color: 'var(--fg-primary)' }}>Exclusion of Consequential Damages:</strong> In no event shall either party be liable for any indirect, incidental, special, exemplary, consequential, or punitive damages, including loss of profits, data, business, or goodwill, even if advised of the possibility of such damages.</p>
                        <p className="mt-4"><strong style={{ color: 'var(--fg-primary)' }}>Exceptions:</strong> Nothing in these Terms limits liability for: (a) death or personal injury caused by negligence; (b) fraud or fraudulent misrepresentation; (c) gross negligence or willful misconduct; or (d) any other liability that cannot be excluded by applicable law.</p>
                    ...
                    <Section id="15" title="15. Termination">
                        <SubSection title="15.1 Termination by You">
                            <p>You may terminate your Subscription at any time from your account dashboard or by contacting <a href="mailto:support@obtura.dev" className="hover:underline" style={{ color: 'var(--brand)' }}>support@obtura.dev</a>. Termination takes effect at the end of the current billing period. No refunds are provided for unused time in the current billing period, except where required by applicable law or under our refund policy in Section 5.5.</p>
                        </SubSection>
                    ...
                    <Section id="16" title="16. Dispute Resolution">
                        ...
                        <SubSection title="16.2 Informal Resolution">
                            <p>Before initiating formal proceedings, both parties agree to attempt good-faith resolution of disputes. Please contact <a href="mailto:legal@obtura.dev" className="hover:underline" style={{ color: 'var(--brand)' }}>legal@obtura.dev</a> with a description of the dispute. We will respond within 10 business days and attempt to resolve the matter within 30 days.</p>
                        </SubSection>

                        <SubSection title="16.3 Jurisdiction">
                            <p>If informal resolution fails, disputes shall be subject to the exclusive jurisdiction of the courts of Bucharest, Romania. Customers who are consumers (not businesses) in the EU also have the right to use the EU Online Dispute Resolution platform at <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="hover:underline" style={{ color: 'var(--brand)' }}>ec.europa.eu/consumers/odr</a>.</p>
                        </SubSection>
                    </Section>
                    ...
                    <Section id="19" title="19. Contact Information">
                        ...
                        <div className="mt-6 grid gap-4 sm:grid-cols-3">
                            {[
                                ...
                                <div key={title} className="border p-5" style={{ borderColor: 'var(--border-default)', background: 'var(--bg-surface)' }}>
                                    <p className="mb-1 text-sm font-semibold" style={{ color: 'var(--fg-primary)' }}>{title}</p>
                        ...
                        <div className="mt-6 border p-5 text-sm" style={{ borderColor: 'var(--border-default)', background: 'var(--bg-surface)' }}>
                            <p className="mb-2 font-semibold" style={{ color: 'var(--fg-primary)' }}>Registered Address</p>
                            <p>Obtura SRL<br />Romania, European Union<br />EU VAT Registered</p>
                        </div>
                    </Section>

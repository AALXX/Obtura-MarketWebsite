...
import { ArrowRight, Check, Calendar, Mail, Users, Building2, Phone, MessageSquare, Globe, Shield, ClipboardCheck, Zap } from 'lucide-react'
...
export default function Contact() {
    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-[#0a0a0a] font-sans text-white mt-15 md:mt-0">
            <section className="relative overflow-hidden py-12 sm:py-20 lg:py-32">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className={`mx-auto max-w-4xl text-center transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                        ...
                        <p className="mx-auto mb-8 max-w-2xl px-4 text-base leading-relaxed text-gray-400 sm:mb-12 sm:text-lg">Book a personalized demo or join our waitlist. See how European SMEs are saving €71K+ per year on DevOps costs.</p>
                            ...
                            <div className="rounded-xl border border-white/10 bg-[#1a1a1a] p-6">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        { icon: <MessageSquare className="h-5 w-5" />, text: 'Custom migration strategy' },
                            ...
                            <div className="rounded-xl border border-white/10 bg-[#1a1a1a] p-6 transition-all duration-500 hover:border-[#ff6b35]/30 sm:p-8">
                                ...
                                <div className="space-y-5">
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="h-12 w-full rounded-lg border border-white/10 bg-[#0a0a0a] px-4 text-white placeholder:text-gray-500 focus:border-transparent focus:ring-2 focus:ring-[#ff6b35] focus:outline-none" placeholder="John Smith" />
                                    </div>
                                    ...
                                    <div className="grid gap-5 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <select id="teamSize" name="teamSize" value={formData.teamSize} onChange={handleChange} className="h-12 w-full rounded-lg border border-white/10 bg-[#0a0a0a] px-4 text-white focus:border-transparent focus:ring-2 focus:ring-[#ff6b35] focus:outline-none">
                                        ...
                                        <>
                                            <div className="grid gap-5 sm:grid-cols-2">
                                                <div>
                                                    ...
                                                    <select id="role" name="role" value={formData.role} onChange={handleChange} className="h-12 w-full rounded-lg border border-white/10 bg-[#0a0a0a] px-4 text-white focus:border-transparent focus:ring-2 focus:ring-[#ff6b35] focus:outline-none">
                                    ...
                                    <button onClick={handleSubmit} disabled={isLoading} className="flex h-14 w-full items-center justify-center gap-2 rounded-lg bg-[#ff6b35] text-base font-semibold text-black shadow-lg shadow-[#ff6b35]/20 transition-all hover:scale-105 hover:bg-[#ff7b45] disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer">
                                        {isLoading ? (
                                            'Submitting...'
                                        ) : (
                                            <>
                                    ...
                                    <p className="text-center text-xs text-gray-500">By submitting, you agree to our Terms of Service and Privacy Policy</p>
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
                        {[
                            ...
                            { icon: <ClipboardCheck className="h-5 w-5 sm:h-6 sm:w-6" />, text: 'SOC 2 Infrastructure' },

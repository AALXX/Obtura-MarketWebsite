...
import { ArrowRight, Check, Zap, TrendingDown, Users, Clock, AlertTriangle, Rocket, BarChart3, GitBranch, Shield, UserCheck, Calculator, Download, Database, Lock, HardDrive, ClipboardCheck, Globe, Calendar, Terminal as TerminalIcon } from 'lucide-react'
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className={`mx-auto max-w-5xl text-center transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                        ...
                        <div className="flex flex-col items-center gap-3">
                            <button type="submit" disabled={isLoading} className="flex h-12 items-center justify-center gap-2 rounded-lg bg-[#ff6b35] px-8 font-semibold text-black shadow-lg shadow-[#ff6b35]/20 transition-all hover:scale-105 hover:bg-[#ff7b45] disabled:cursor-not-allowed disabled:opacity-50">
